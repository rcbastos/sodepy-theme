 ...
 */
?>
<!-- wp:group {"tagName":"section","className":"video-autoplay-section","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"}},"color":{"background":"var:preset|color|primary"}},"layout":{"type":"default"}} -->
<section class="wp-block-group video-autoplay-section" style="background:var(--wp--preset--color--primary)">
	...
	<div class="video-autoplay-overlay" aria-hidden="true" style="position:absolute;inset:0;background:linear-gradient(135deg,rgba(10,38,80,0.75) 0%,rgba(23,110,181,0.4) 100%);z-index:1;"></div>
	<!-- /wp:html -->

	<!-- wp:group {"className":"video-autoplay-content","style":{"spacing":{"padding":{"top":"var:preset|spacing|100","bottom":"var:preset|spacing|100","left":"var:preset|spacing|60","right":"var:preset|spacing|60"}}},"layout":{"type":"constrained"}} -->
	<div class="wp-block-group video-autoplay-content">

		<!-- wp:group {"layout":{"type":"flex","orientation":"vertical","rowGap":"var:preset|spacing|50","justifyContent":"center"},"style":{"textAlign":"center","maxWidth":"800px","margin":{"left":"auto","right":"auto"}}} -->
